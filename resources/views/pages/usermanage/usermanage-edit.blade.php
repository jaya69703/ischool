                        ...
                        <div class="tab-content" id="rounded-pills-icon-tabContent">
                            <div class="tab-pane fade show active" id="rounded-pills-icon-home" role="tabpanel" aria-labelledby="rounded-pills-icon-home-tab">
                                <div class="image text-center">
                                    <img src="{{ asset('storage/images/user/'.$usermanage->photo) }}" class="card-img-top img-fluid" style="width: 250px; height: 250px;" alt="Profile-Picture" id="image-preview">
                                </div>
                                <div class="row">
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                        <label for="name">Nama</label>
                                        <input type="text" id="name" name="name" class="form-control" value="{{ $usermanage->name }}">
                                    </div>
                                    @if($usermanage->type === 0)
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                    ...
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                        ...
                                        <input type="text" id="divisi_id" name="divisi_id" class="form-control" value="{{ $usermanage->staff->position->divisi->name }}">
                                    </div>
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                        <label for="divisi_id">Jabatan</label>
                                        <input type="text" id="divisi_id" name="divisi_id" class="form-control" value="{{ $usermanage->staff->position->name }}">
                                    </div>
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                        <label for="name">Awal Masuk Kerja</label>
                                        <input type="date" id="name" name="name" class="form-control" value="{{ $usermanage->staff->start }}">
                                    </div>
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                        <label for="name">Nomor Surat Keputusan</label>
                                        <input type="text" id="name" name="name" class="form-control" value="{{ $usermanage->staff->sknumber }}">
                                    </div>
                                    @elseif($usermanage->type === 1)
                                    <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-12 row">
                                        ...
                                        <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control" value="{{ $usermanage->email }}">
                                        </div>
                                        <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                            <label for="name">Nomor Telepon</label>
                                            <input type="text" id="name" name="name" class="form-control" value="{{ $usermanage->phone }}">
                                        </div>
                                        <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                        ...
                                        <div class="form-group col-lg-6 col-12 mt-2 mb-2">
                                            ...
                                            <input type="date" id="name" name="name" class="form-control" value="{{ $usermanage->name }}">
                                        </div>
                                        <div class="form-group col-lg-6 col-12 mt-2 mb-2">
